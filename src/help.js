...
module.exports.run = async (bot, message, args, cube) => {
	let helpEmbed = new Discord.RichEmbed()
		...
		.addField("WCA", "6x6, 7x7, skewb, pyra, mega, sq1, clock, fmc")
		.addField("Non-WCA", "redi, ivy, 2x2x3, 2bld, 1x1, 8x8, crosssolved, kilominx")
		.addField("Multi-Argument", "3x3 (bld, oh, corner, edge, double, cross (white, yellow, orange, red, blue, green, random), superflip, feet, oll, pll, zbll, ll), 4x4 (bld), 5x5 (bld), 2x2 (bld)")
