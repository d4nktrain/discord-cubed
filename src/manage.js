...
module.exports.run = async (bot, message, args, cube) => {
	if(!message.author.id.includes("182620322846081024")) if(!message.member.hasPermission("MANAGE_MESSAGES") && !message.member.hasPermission("MANAGE_GUILD")) return message.reply("You do no have permission to use this command. Missing permission: `MANAGE_MESSAGES`").then(msg => msg.delete(7000))
