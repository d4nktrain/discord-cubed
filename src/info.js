...
module.exports.run = async (bot, message, args, cube) => {
	...
	let embed = new Discord.RichEmbed()
		...
		.addField("Description", "Scrambler is a Discord bot that generates scrambles for common twisty puzzles. Concept originated from ecuber#0566, this version of bot has been coded mostly by Bacon#1153, revised with new features by ecuber and TheUPSTruck.")
		.setTimestamp()
